...
label = Label(root, text='Click "RUN" to capture the key-loggers.')
label.config(anchor=CENTER)
label.pack()

start_button = Button(root, text="RUN", command=start_keylogger)
start_button.pack(side=LEFT)

stop_button = Button(root, text="TERMINATE", command=stop_keylogger, state='disabled')
